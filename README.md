...
|                              write\_output\_files                              | string |  false   |      `"false"`      |                                  Write outputs to the `output_dir` <br>defaults to `.github/outputs` folder. **NOTE:** <br>This creates a `.txt` (default) <br>and `.json` file if `json` <br>is set to `true`.                                   |
