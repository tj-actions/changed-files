...
|          json\_raw\_format          | string |  false   |      `"false"`      |                                  Output list of changed files jq<br> raw output format which means that<br> the output will not be surrounded<br> by quotes and special characters will<br>not be escaped.                                  |
