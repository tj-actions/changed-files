...
|          max\_fetch\_depth          | string |  false   |        `"120"`        |                                    Max limit for fetching branch<br>history. **NOTE**: This can be<br>adjusted to resolve errors with<br>insufficient history.                                     |
