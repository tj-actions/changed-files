...
|:--------------------:|:------------:|:----------------------------------:|:----------------------------------------:|
| any_changed          |  `string`    |  `true` OR `false`                 | Returns `true` when any <br /> of the filenames provided using <br /> the `files` input has changed.
i.e. *using a combination of all added, <br />copied, modified and renamed files (ACMR).* |
