...
|          max\_fetch\_depth          | string |  false   |       `"6000"`        |                                                   Maximum depth of the branch history fetched.<br>**NOTE**: This can be adjusted to resolve<br>errors with insufficient history.                                                    |
