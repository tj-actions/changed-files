...
|               dir\_names               |       `boolean`        | `false`  |        `false`        |                                                                             Output the absolute path to the changed directories instead of the filenames. <br> NOTE: This returns `.` for <br> changed files located in the root of the project.                                                                              |
